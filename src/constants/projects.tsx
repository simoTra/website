...
export const projects = [
  {
    ...
    content: (
      <div className="text-neutral-400 prose pt-6">
        ...
        <p className="text-neutral-400 mb-4">
          As a fan of the classic Telecaster design, I knew I wanted to
          start with this iconic shape as the foundation for my custom creation
          (let&apos;s face it, it&apos;s also the electric guitar with the simplest design
          ;)). However, I also wanted to push the boundaries and incorporate
          modern elements and personal touches into the design. This project was
          not just about replicating what already existed but about innovating
          and bringing something unique to life.
        </p>
        ...
        <div className="text-neutral-400 grid grid-cols-1 md:grid-cols-2 gap-4">
          <img
            className="text-neutral-400 rounded-lg shadow-lg"
        ...
        <p className="text-neutral-400 mt-4 mb-4">
          ...
          of the kit was not of high quality (to tell the truth, it didn&apos;t have
          any quality at all). Amazon came to the rescue, without exceeding the
          budget too much, I found a maple neck much better than the previous
          one.
        </p>
        <img
          className="text-neutral-400 rounded-lg shadow-lg my-4"
        ...
        <p className="text-neutral-400 mb-4">
          ...
          remains a plastic guitar, not so sought-after hardware, but it doesn&apos;t
          matter!
        </p>
        <p className="text-neutral-400 mb-4">
        ...
        <p className="text-neutral-400 mb-4">
          If you&apos;ve made it this far reading, perhaps you&apos;d like to know how
          this guitar sounds;{" "}
          <a
            href="https://www.instagram.com/p/CAia8cyiztElNtJCSGQwOscDkDcHex3dqL_Uw80/"
            className="text-neutral-400 hover:underline"
  ...
  },
  {
    href: "https://www.instagram.com/p/CAia8cyiztElNtJCSGQwOscDkDcHex3dqL_Uw80/",
    title: "st_keeb",
    description: "The alice-like keyboard you&apos;re looking at.",
    thumbnail: stKeeb,
    images: [],
    stack: ["3D Modeling", "Fusion360", "Electronic", "Plasma Cutting"],
    slug: "st_keeb",
    content: (
      <div className="text-neutral-400 prose mx-auto p-6">
        <h1 className="text-neutral-400 text-3xl font-bold mb-4">
        ...
        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Microcontroller</h2>
        <p className="text-neutral-400 mb-4">
          The keyboard is powered by an Arduino Pro Micro microcontroller,
          connected to each switch using a matrix scheme.
        </p>

        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Switches</h2>
        <p className="text-neutral-400 mb-4">
        ...
        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Bill of Materials (BOM)</h2>
        <ul className="text-neutral-400 list-disc ml-6 mb-6">
        ...
        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Photos</h2>
        <table className="text-neutral-400 table-auto w-full text-center mb-6">
          <thead>
            <tr>
        ...
        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Future Improvements</h2>
        <p className="text-neutral-400 mb-4">
        ...
        <h2 className="text-neutral-400 text-2xl font-semibold mb-4">Conclusion</h2>
        <p className="text-neutral-400 mb-4">
          If you&apos;re looking for a high-quality, handwired keyboard that is both
          aesthetically pleasing and functional, this design is an excellent
          choice. With its unique design, premium materials, and exceptional
          switches, it offers a fantastic typing experience. The 3D-printed
          parts add customization options and ease of assembly, making it a
